...
/** Provider-neutral setup guide — linked from every CRM marketplace listing (Pipedrive, Zoho, etc.). */
    ...
    <div className="mx-auto max-w-2xl px-6 py-12">
      <Card className="p-8">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-[var(--color-text-secondary)]">
          ...
          <li>An account with the CRM you want to connect that you can log into and approve access for.</li>
        </ul>

        <h2 className="mt-8 text-[17px] font-semibold">Connect your CRM (one-time)</h2>
        <ol className="mt-2 list-decimal space-y-2 pl-5 text-sm">
          <li>In LeadIntel, open <strong>Settings → CRM</strong>.</li>
          <li>Click <strong>Connect</strong> next to your CRM.</li>
          <li>In the pop-up, choose your account and approve access to your contacts.</li>
          <li>The window closes and the CRM shows as <strong>Connected</strong>. That’s it.</li>
        </ol>
        <p className="mt-3 text-sm text-[var(--color-text-secondary)]">
          Prefer Zapier, Make, or your own endpoint? Choose <strong>Webhook / Zapier</strong>, paste your URL, and click Save — no login needed.
        </p>

        <h2 className="mt-8 text-[17px] font-semibold">Send leads to your CRM</h2>
        <ul className="mt-2 list-disc space-y-2 pl-5 text-sm">
          ...
          <li><strong>Automatically:</strong> in Settings → CRM, turn on <strong>“Auto-sync every new qualified lead”</strong> so new leads flow into your CRM on their own. You can also include cold leads.</li>
        </ul>
        <p className="mt-3 text-sm text-[var(--color-text-secondary)]">
          Each lead becomes a contact with its business name, email, phone, website, and city. LeadIntel remembers what’s already been sent, so leads are never duplicated.
        </p>

        <h2 className="mt-8 text-[17px] font-semibold">Disconnect</h2>
        <p className="mt-2 text-sm text-[var(--color-text-secondary)]">
          Go to <strong>Settings → CRM</strong> and click <strong>Disconnect</strong> at any time. You can also remove access from within your CRM under its connected-apps settings.
        </p>
